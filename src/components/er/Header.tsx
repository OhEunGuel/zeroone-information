...
import PlayerSearchBar from '@/components/er/PlayerSearchBar'
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="h-16 flex items-center justify-between gap-6">
          ...
          <div className="hidden md:block flex-1 max-w-xl">
            <PlayerSearchBar variant="compact" placeholder="플레이어 닉네임을 입력해주세요." />
          </div>
          <nav className="text-sm text-[var(--brand-muted)] flex items-center gap-5">
            ...
            <Link href="/er/minigame" className="hover:text-[var(--brand-deep)]">미니게임</Link>
